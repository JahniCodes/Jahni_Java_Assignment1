...
public class Chap3_exer_317Test {
    ...
    Chap3_exer_317DoB DoB = new Chap3_exer_317DoB(month, day, year);
    Chap3_exer_317 newPatient = new Chap3_exer_317(firstName, lastName, gender, DoB, height, weight);
